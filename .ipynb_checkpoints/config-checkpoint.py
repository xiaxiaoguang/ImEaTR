...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        parser.add_argument("--dset_name", type=str, choices=["hl","charades","anet","tacos"])
        ...
        # * Transformer
        parser.add_argument("--CMAenc_layers", default=3,type=int,help="Number of Cross Modality layers in the transformer")
        ...
        # Loss
        parser.add_argument("--lw_saliency", type=float, default=1.5, help="weight for saliency loss, set to 0 will ignore")
        ...
        parser.add_argument("--attention_weights_align", action="store_true", help="Disable attention_weights_align between given text and video.")        
        parser.add_argument("--negative_saliency", action="store_true", help="Disable negative_saliency_loss in the negative video part.")
        parser.add_argument("--dvae_mse", action="store_false", help="Loss for trainning slot attention")
        parser.add_argument("--object_CE", action="store_false", help="Loss for trainning slot attention")
        ...
        # * Loss coefficients
        parser.add_argument('--dvae_mse_coef', default=1, type=float)
        parser.add_argument('--object_CE_coef', default=10, type=float)
        ...
        parser.add_argument("--attention_weights_align_coef", default=0.2, type=float)
        parser.add_argument("--negative_saliency_coef", type=float, default=10., help="weight for negative saliency loss, set to 0 will ignore")
