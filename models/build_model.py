...
def build_model(args):
    ...
    transformer = Transformer(
        ...
        num_CMAencoder_layers=args.CMAenc_layers,
    ...
    model = EaTR(
        ...
        attention_weights_align=args.attention_weights_align,
        negative_saliency = args.negative_saliency,
    ...
    #"dvae_mse" : args.dvae_mse_coef,
    #"object_CE" : args.object_CE_coef,
    if args.dvae_mse:
        weight_dict["dvae_mse"] = args.dvae_mse_coef
    if args.object_CE:
        weight_dict["object_CE"] = args.object_CE_coef
    if args.attention_weights_align:
        weight_dict["attention_weights_align"] = args.attention_weights_align_coef
    if args.contrastive_align_loss:
        weight_dict["loss_contrastive_align"] = args.contrastive_align_loss_coef
    if args.negative_saliency:
        weight_dict["loss_negative_saliency"] = args.negative_saliency_coef
